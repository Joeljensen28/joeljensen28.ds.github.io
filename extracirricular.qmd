...
## [DreamNet (raw audio generative AI model)](https://github.com/Joeljensen28/DreamNet)

This project is what I'm currently working on in my free time to expand my knowledge of neural networks and generative AI. The model will be trained on >50 hours of dreampunk music, a genre of electronic music known for its surreal and often incoherent soundscapes. My goal with this is to see if the often surreal artifacts and other incoherencies that emerge from generative AI might enhance the dreampunk genre.
